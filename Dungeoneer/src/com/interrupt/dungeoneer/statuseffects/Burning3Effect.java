...
public class Burning3Effect extends StatusEffect {
    public float damageTimer = 60;
    public int damage = 1;
    private float dtimer = 0;

    public Burning3Effect() {
        this(600, 160, 3);
    }

    public Burning3Effect(int time, int damageTimer, int damage) {
        this.name = StringManager.get("statuseffects.Burning3Effect.defaultNameText");
        this.timer = time;
