...
public class Poison3Effect extends StatusEffect {
    ...
    public Poison3Effect() {
        this(1000, 160, 3, true);
    }

    public Poison3Effect(int time, int damageTimer, int damage, boolean canKill) {
