...
public class Poison2Effect extends StatusEffect {
    ...
    public Poison2Effect() {
        this(1000, 160, 2, false);
    }

    public Poison2Effect(int time, int damageTimer, int damage, boolean canKill) {
        this.name = StringManager.get("statuseffects.Poison2Effect.defaultNameText");
        this.timer = time;
