...
public class Burning2Effect extends StatusEffect {
    public float damageTimer = 60;
    public int damage = 1;
    private float dtimer = 0;

    public Burning2Effect() {
        this(600, 160, 3);
    }

    public Burning2Effect(int time, int damageTimer, int damage) {
        this.name = StringManager.get("statuseffects.Burning2Effect.defaultNameText");
        this.timer = time;
