...
public class ClassManager {
	...
	public ClassManager() {
		...
		classes.add(new Class("ARCHER", new Stats(2, 2, 6, 6, 2, 4), "BOW,FOOD,WAND,POTION", false));
		classes.add(new Class("WIZARD", new Stats(2, 2, 2, 6, 6, 4), "BOOK,FOOD,WAND,POTION", false));
	}
