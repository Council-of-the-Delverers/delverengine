...
public class WorldMapOverlay extends MessageOverlay {

    public WorldMapOverlay(String inkFile, NinePatchDrawable background, Color textColor) {
    ...
    public void makeMessage() {
        ...
        if(story.getCurrentChoices().size() > 0) {
            ...
            for (Choice c : story.getCurrentChoices()) {
                ...
                choicesTable.add(choiceLabel).minWidth(200).bottom();
                choicesTable.row();
